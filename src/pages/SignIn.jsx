          ...
          <form>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p className='mb-6'>Don't have an account?
                <span className='cursor-pointer text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1' onClick={()=>Navigate("/sign-up")}>Register</span>
              </p>
              <p>
                <span className='cursor-pointer text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out' onClick={()=>Navigate("/forgot-password")}>Forgot Password?</span>
              </p>
            </div>
